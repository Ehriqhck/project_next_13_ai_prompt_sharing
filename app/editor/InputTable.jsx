...
import { SelectContext, SelectedActionContext, SelectedEditorDeviceContext, Context } from '@components/Provider';
...
export default function TreeTableDialogue() {
    ...
    useEffect(() => {
        ...
        try {
            SessionDeviceInputs.getTreeTableNodes(selectedEditorDevice, profileContext).then((data) => setNodes(data));
    ...
    return (
        <div className="flex w-full flex-col gap-[8px] pb-[8px]">
            <Button onClick={() => {
                console.log(JSON.parse(sessionStorage.getItem('loadedProfiles')));
                console.log("CONTEXT:");
                console.log(profileContext);
            }}>check sessionStorage</Button>
