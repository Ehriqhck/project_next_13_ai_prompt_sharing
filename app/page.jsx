    ...
    <div className="flex flex-col w-full text-[#DAF0EA]">
      <div className="flex flex-col w-full  hero-bg  ">
        <div className="bg-multiply w-full h-full flex flex-col px-[128px]  content-between">
          <div className="flex flex-col w-fit font-['varino'] mt-[12vh] self-start max-[1440px]:mb-[128px] min-[700px]:mb-[64px]">
          ...
          <section className='w-full self-end flex-row pt-[64px] h-full justify-end pb-[128px]' >
            <div className="flex gap-[20px] z-10 flex-col mb-[0px] self-end justify-end align-bottom ">
              <p className=" flex flex-col self-center justify-center align-middle flex-nowrap whitespace-nowrap
          ...
          "> DISCOVER MORE BELOW </p>
            ...
            <NoSsr>
              <div className="flex flex-row gap-[4px] hero-carousel max-w-[900px] w-full h-fit">
