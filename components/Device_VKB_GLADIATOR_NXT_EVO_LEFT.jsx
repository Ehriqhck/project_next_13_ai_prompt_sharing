    ...
    case "Front":
      return (
        <>
          ...
          <InputPopover InputId={"Chip_Stick"} InputName={"CHIP STICK"} TargetId={"#input5"} />
          <InputPopover InputId={"Pill_Stick"} InputName={"PILL STICK"} TargetId={"#input1"} />
          <InputPopover InputId={"Hat_Stick"} InputName={"HAT STICK"} TargetId={"#input2"} />
          <InputPopover InputId={"Circle_Stick"} InputName={"CIRCLE STICK"} TargetId={"#input3"} />
          <InputPopover InputId={"Red_Button"} InputName={"RED BUTTON"} TargetId={"#input4"} />
