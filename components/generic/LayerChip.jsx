...
// document.querySelector('[type=button]').addEventListener('click', setChecked);
    ...
    if (isButton === 'true') {
        const layerClass = "selectedModLayer" + layerNumber + " " + "modifier-chip-" + layerNumber + "-button"
        // const checked = () => {
        //     if (layerNumber === 0) {
        //         return true
        //     } else {
        ...
        return (
            ...
            <label
                ...
                for={"choice-" + layerNumber}
                className={"isButton flex gap-[6px] " + layerClass}
            >

                <input type="radio" value={layerNumber} name="modselect" id={"choice-" + layerNumber}  />
