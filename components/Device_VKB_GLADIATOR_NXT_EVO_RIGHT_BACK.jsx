          ...
          <g id="Device_VKB_GLADIATOR_NXT_EVO_RIGHT_BACK">
            ...
            <g
              ...
              className="selected-input corner-test" onClick={() => {
                ...
                console.log("setSelectedViewerInput pinkybutton_Device_VKB_GLADIATOR_NXT_EVO_RIGHT_BACK")
              }}>
              <path
            ...
            <g id="sideIndexButton_Device_VKB_GLADIATOR_NXT_EVO_RIGHT_BACK"
              className="selected-input corner-test" onClick={() => {
                ...
                console.log("setSelectedViewerInput sideIndexButton_Device_VKB_GLADIATOR_NXT_EVO_RIGHT_BACK")
              }}
            >
              <path
            ...
            <g
              ...
              className="selected-input corner-test" onClick={() => {
                ...
                console.log("setSelectedViewerInput primaryTrigger_Device_VKB_GLADIATOR_NXT_EVO_RIGHT_BACK")
              }}
            >
              <path
                d="M69.36 126.25c.92 1.85 2.16 4.51 3.35 7.82 1.17 3.23 5.41 15.72 4.09 32.53-.37 4.76-1.31 11.28-3.72 18.81.18.51.47 1.17.96 1.85a7.324 7.324 0 0 0 2.56 2.2l12.11 1.65c2.67-.2 5.33-.41 8-.61 1.12-.11 2.58-.38 4.2-.99 1.99-.75 3.48-1.76 4.47-2.54.45-8.62.08-20.86-3.76-34.82-2.47-8.96-7.36-26.59-22.29-42.06-2.3-2.38-5.72-5.38-5.72-5.38l-5.01 2.41s-.04 3.8 0 7.09c1.69 3.05 3.86 7.89 5.55 10.95-1.6.37-3.19.73-4.79 1.1Z"
            ...
            <g
              ...
              className="selected-input corner-test" onClick={() => {
                ...
                console.log("setSelectedViewerInput secondaryTrigger_Device_VKB_GLADIATOR_NXT_EVO_RIGHT_BACK")
              }}
            >
              <path
