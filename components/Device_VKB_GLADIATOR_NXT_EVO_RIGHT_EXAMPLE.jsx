...
const Device_VKB_GLADIATOR_NXT_EVO_RIGHT_EXAMPLE = (props) => {
  ...
  switch (selectedEditorDeviceViewOrientation) {
            ...
            >
              <defs>
                <linearGradient
                  ...
                  y1={6.567}
                  y2={466.777}
                  gradientTransform="matrix(-1 0 0 1 261.821 0)"
                ...
                <linearGradient
                  ...
                  y1={399.759}
                  y2={415.274}
                  gradientTransform="scale(-1 1) rotate(-16.23 -60.981 1323.552)"
                  gradientUnits="userSpaceOnUse"
                >
                ...
                <radialGradient
                  ...
                  fx={-50.925}
                  fy={118.002}
                  gradientTransform="matrix(-.56786 .82313 .83794 .57808 201.873 27.367)"
                  gradientUnits="userSpaceOnUse"
                >
                ...
                <radialGradient
                  ...
                  fx={184.951}
                  fy={171.308}
                  gradientTransform="rotate(-140.837 254.994 -45.102) scale(1 -1.245)"
                  gradientUnits="userSpaceOnUse"
                >
                ...
                <radialGradient
                  ...
                  fx={106.145}
                  fy={48.694}
                  gradientTransform="rotate(-51.685 237.707 57.193) scale(1 -1.124)"
                  gradientUnits="userSpaceOnUse"
                >
                ...
                <radialGradient
                  ...
                  fx={94.614}
                  fy={65.918}
                  gradientTransform="matrix(-1 0 0 .997 261.821 1.759)"
                  gradientUnits="userSpaceOnUse"
                >
              ...
              <g id="Device_VKB_GLADIATOR_NXT_EVO_RIGHT_BACK">
                <g id="Layer_13">
                  <path
                ...
                <g
                  id="Layer_17_Device_VKB_GLADIATOR_NXT_EVO_RIGHT_BACK"
                  style={{
                ...
                >
                  <image
                    ...
                    width={250}
                    height={77}
                    transform="translate(37.825 54.497)"
                  />
                  <g
                    style={{
                      opacity: 0.53,
                  ...
                  >
                    <path
                      d="M94.495 18.914c33.26 8.316 66.506 17.163 99.766 25.48 20.814 3.181 48.036 9.888 68.85 13.068"
                      style={{
                    ...
                    <image
                      ...
                      width={171}
                      height={47}
                      transform="translate(92.825 14.497)"
                    />
                  </g>
                  <path
                    d="m283.036 63.096-2.117 40.952-51.879-8.943a140.379 140.379 0 0 0-23.117-2.038l-20.517-.106 2.508-51.659 24.426 6.642 70.695 15.152Z"
                    style={{
                  ...
                  />
                  <path
                    d="m220.199 89.722-171.212.505L4.342 531.846l292.869-112.04-16.17-318.124-60.842-11.96z"
                    style={{
                  ...
                  />
                  <path
                    d="m280.919 104.048-64.361-11.087-14.395 17.165-11.501 73.707 66.593 12.169 23.664-91.954z"
                    style={{
                  ...
                  <image
                    ...
                    width={293}
                    height={477}
                    transform="translate(-72.175 71.497)"
                  />
                </g>
                <g id="greebles_Device_VKB_GLADIATOR_NXT_EVO_RIGHT_BACK">
                  <path
                    d="M136.412 2.266s35.117 13.174 68.668 33.17l-77.787-16.585 9.118-16.585Z"
                    style={{
                  ...
                  />
                  <path
                    d="M64.328 13.149c8.661-4.743 17.313-5.351 17.313-5.351a39.897 39.897 0 0 1 14.165 1.574l5.981-8.814c11.778-.505 17.874-1.518 34.625 1.709l-8.993 15.078-11.979-.624s-4.647-.123-7.823.609c-.919.212-4.742 1.145-8.875 3.858-1.563 1.026-5.538 3.86-11.488 13.6a104.324 104.324 0 0 0-8.485 17.352L67.073 92.961l-23.797-3.598-1.757-2.051-2.062-2.406-.94-30.207c.265-1.294 6.715-31.094 25.812-41.55Z"
                    style={{
                ...
                >
                  <path
                    d="M160.85 49.67c1.494-.97 10.599-6.666 21.874-3.631 8.03 2.162 12.634 7.534 14.165 9.5 1.096 2.5 2.583 6.945 1.817 12.25-1.46 10.105-10.371 18.283-20.423 20.074-8.077 1.439-17.743-1.093-23.364-8.33-1.135-1.461-5.196-6.864-4.418-14.411 1.014-9.844 9.39-14.895 10.35-15.452Z"
                    style={{
                  ...
                  />
                  <path
                    d="M149.008 68.145c0 10.192 9.129 18.454 20.39 18.454 14.507 0 23.079-11.158 23.079-20.681 0-10.68-9.887-18.666-21.148-18.666s-22.321 6.469-22.321 20.893Z"
                    style={{
                  ...
                  />
                  <path
                    d="M169.94 49.835c-6.531-.786-11.501 1.832-13.2 2.83-.788.547-7.994 5.711-7.724 13.794.119 3.555 1.634 6.104 2.303 7.204 4.461 7.333 13.066 8.3 14.064 8.396 7.307.702 12.574-3.119 13.85-4.102 1.324-1.019 4.228-3.523 5.546-7.876 2.285-7.548-2.399-13.807-2.629-14.103-3.995-5.155-9.886-5.863-12.211-6.143Z"
                    style={{
                ...
                <g
                  id="primaryTrigger_Device_VKB_GLADIATOR_NXT_EVO_RIGHT_BACK"
                  style={{
                ...
                >
                  ...
                  />
                  <path
                    d="m205.386 209.816-16.204-1.805-20.933 1.805 5.688 7.284s21.802 2.483 22.465 1.734 14.067-6.369 14.067-6.369l-5.083-2.65Z"
                    className="cls-22"
                  />
                  <path
                    d="M190.176 209.492a149.127 149.127 0 0 1-4.675-22.969c-.966-7.864-2.003-16.307-.688-27.35.802-6.739 2.181-17.413 8.812-29.069a66.885 66.885 0 0 1 9.255-12.57l-1.752-9.571-29.543 34.825-5.636 68.509 24.227-1.805Z"
                    className="cls-22"
                  />
                  <path
                    d="M190.176 209.492a149.127 149.127 0 0 1-4.675-22.969c-.966-7.864-2.003-16.307-.688-27.35.802-6.739 2.181-17.413 8.812-29.069a66.885 66.885 0 0 1 9.255-12.57l-1.752-9.571-29.543 34.825-5.636 68.509 24.227-1.805Z"
                  ...
                  <image
                    ...
                    width={43}
                    height={7}
                    transform="translate(166.825 205.497)"
                  />
                </g>
                <g
                  id="secondaryTrigger_Device_VKB_GLADIATOR_NXT_EVO_RIGHT_BACK"
                  style={{
                ...
                >
                  <path
                    d="m208.136 127.765 10.432-1.321 18.71 18.626a63.5 63.5 0 0 0 2.965 1.205c7.677 2.892 14.867 3.87 20.757 4.056l1.404-1.914a99.652 99.652 0 0 1-3.546-12.769c-.896-4.326-2.36-11.528-2.072-20.907a79.066 79.066 0 0 1 1.289-11.992l-22.52-4.068a16.01 16.01 0 0 0-6.472 1.206l-16.726 20.171-4.221 7.708Z"
                    style={{
                  ...
                  />
                  <path
                    d="M207.206 98.166h38.844v49.238h-38.844z"
                    style={{
                  ...
                  />
                  <path
                    d="M238.381 145.773s2.383.164 5.186-.493a20.084 20.084 0 0 0 1.84-.545c1.095-.387 1.844-.77 2.174-.923 2.117-.98 5.942-1.284 13.439 1.85 3.664 1.622 5.436 3.068 5.318 4.338-.29 3.114-9.808 6.77-18.389 5.084-5.663-1.112-9.542-4.291-11.418-6.074.392-2.073 1.851-3.238 1.851-3.238Z"
                    style={{
                      fill: "#005748",
                      strokeWidth: 0,
                    }}
                  />
                  <path
                    d="M229.561 99.367a87.712 87.712 0 0 0 .137 15.522c.357 3.631.809 7.968 2.544 13.399 1.678 5.252 3.006 9.234 6.741 12.553 2.805 2.492 5.835 3.603 7.798 4.135 6.693 1.073 14.017 2.955 20.71 4.028 13.133-20.446 6.779-44.665-6.746-52.34-13.25-7.519-30.279 2.169-31.185 2.702Z"
                    style={{
    ...
    case "Front":
      return (
        <>
          <InputPopover InputId={"Chip_Stick_Device_VKB_GLADIATOR_NXT_EVO_RIGHT"} InputName={"CHIP STICK"} TargetId={"#input5_Device_VKB_GLADIATOR_NXT_EVO_RIGHT"} />
          <InputPopover InputId={"Pill_Stick_Device_VKB_GLADIATOR_NXT_EVO_RIGHT"} InputName={"PILL STICK"} TargetId={"#input1_Device_VKB_GLADIATOR_NXT_EVO_RIGHT"} />
          <InputPopover InputId={"Hat_Stick_Device_VKB_GLADIATOR_NXT_EVO_RIGHT"} InputName={"HAT STICK"} TargetId={"#input2_Device_VKB_GLADIATOR_NXT_EVO_RIGHT"} />
...
export default Device_VKB_GLADIATOR_NXT_EVO_RIGHT_EXAMPLE
